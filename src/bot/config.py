...
class Settings(BaseSettings):
    ...
    reddit_api_base_url: HttpUrl = Field("https://oauth.reddit.com", alias="REDDIT_API_BASE_URL")
    reddit_token_url: HttpUrl = Field("https://www.reddit.com/api/v1/access_token", alias="REDDIT_TOKEN_URL")
